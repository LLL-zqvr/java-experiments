...
public class Test {
        ...
        public static void main(String[] args) throws IOException {
            String fileName = "C:/桌面/example/test.txt";
            ...
            String toFile = "C:/桌面/example/to.txt";
            copyByIO(fileName, toFile);

            System.out.println("--------- 基于NIO实现文件的复制 ----------");
            String toFile2 = "C:/桌面/example/nio/to.txt";
        ...
        private static void createFile(String fileName) throws IOException {
            ...
            try{
                ...
                System.out.println("文件创建成功,文件位置为：" + fileName);
            }
        ...
        private static void writeToFile(String fileName, String content) throws IOException {
            ...
            try(FileOutputStream outputStream = new FileOutputStream(fileName)) {
                ...
                System.out.println("数据写入成功。文件位置为：" + fileName);
            } catch (IOException e) {
                e.printStackTrace();
            }
